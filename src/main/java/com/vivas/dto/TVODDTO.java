...
import com.vivas.utils.JSONUtils;
 ...
 */
public class TVODDTO {
    private String success;
    private String type;
    private String apis_version;
    private String quantity;
    private String total_quantity;
    private List<TVODItemDTO> items;
    ...
    public static void main(String[] args) {
        ...
        TVODDTO tvod = (TVODDTO) JSONUtils.stringToObject(jsonString,TVODDTO.class);
        System.out.println(tvod.toString());
