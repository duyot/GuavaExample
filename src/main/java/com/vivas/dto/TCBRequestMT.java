...
public class TCBRequestMT {
    ...
    public TCBRequestMT(String msgID, String sender, String mobinumber, String msgText, String msgType, String moID, String priority, String localTime, String extension, String signature) {
        MsgID = msgID;
        Sender = sender;
